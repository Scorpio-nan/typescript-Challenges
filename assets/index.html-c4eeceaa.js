import{_ as u,r as c,o as l,c as r,a,b as n,e as t,d as p,F as k,f as d,t as g}from"./app-b584e672.js";const h="/blog/assets/1-d5ef3e36.png",m="/blog/assets/2-f8b464c6.png",y="/blog/assets/3-d0ea9c33.png",v="/blog/assets/20-cc59a4b7.png",x="/blog/assets/4-bb258abc.png",b="/blog/assets/5-d24d4e55.png",f="/blog/assets/6-6b78a16c.png",j="/blog/assets/9-17429043.png",w="/blog/assets/10-f5b2edf9.png",V="/blog/assets/11-14dda920.png",S="/blog/assets/12-1f60e0ec.png",q="/blog/assets/13-75401e06.png",C="/blog/assets/7-1d5afda0.png",P="/blog/assets/8-70c467d1.png",E="/blog/assets/14-a54ca368.png",L="/blog/assets/15-c6bcd2a5.png",M="/blog/assets/16-5e06becd.png",A="/blog/assets/17-e4a8ebb7.png",T="/blog/assets/18-8ca5d09c.png",B="/blog/assets/19-2ab2e3d2.png",$={},H={id:"vuepress",tabindex:"-1"},J={href:"https://github.com/wangtunan/vuepress-blog-demo",target:"_blank",rel:"noopener noreferrer"},D={href:"https://emoji.muan.co/",target:"_blank",rel:"noopener noreferrer"},I={href:"https://gitmoji.carloscuesta.me/",target:"_blank",rel:"noopener noreferrer"},R={href:"https://www.baidu.com",target:"_blank",rel:"noopener noreferrer"},N={id:"vue",tabindex:"-1"},G={id:"vuex",tabindex:"-1"},W={id:"vue-resource",tabindex:"-1"},Y={href:"https://community.algolia.com/docsearch/",target:"_blank",rel:"noopener noreferrer"};function O(U,s){const o=c("Badge"),e=c("ExternalLinkIcon");return l(),r("div",null,[a("h1",H,[s[0]||(s[0]=a("a",{class:"header-anchor",href:"#vuepress","aria-hidden":"true"},"#",-1)),s[1]||(s[1]=n(" VuePress ")),t(o,{text:"0.x"})]),a("p",null,[s[3]||(s[3]=n("本")),s[4]||(s[4]=a("code",null,"blog",-1)),s[5]||(s[5]=n("配套了一个基于 VuePress 的一个简单的配置案例，此配置案例包含了本")),s[6]||(s[6]=a("code",null,"blog",-1)),s[7]||(s[7]=n("绝大部分配置案例，更多详情请移步这里")),a("a",J,[s[2]||(s[2]=n("VuePress配置案例")),t(e)])]),s[39]||(s[39]=p(`<h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><h3 id="如何而来" tabindex="-1"><a class="header-anchor" href="#如何而来" aria-hidden="true">#</a> 如何而来</h3><p>VuePress 是一个<strong>静态网站生成器</strong>，使用它我们一方面可以专注输出技术类文档，也可以使用基于Vue的开发方式来开发我们其它的静态网站。<br> 每一个由 VuePress 生成的静态页面都是经过服务端渲染(SSR)而来，因此由 VuePress 生成的页面在加载性能和搜索引擎优化(SEO)上有很明显的优势。</p><h3 id="组成部分" tabindex="-1"><a class="header-anchor" href="#组成部分" aria-hidden="true">#</a> 组成部分</h3><p>通常而言，一个由 VuePress 生成的网站，它是用<code>Vue</code>、<code>Vue-router</code>、<code>Webpack</code>以及利用服务端渲染(<code>SSR</code>)而来，它不仅支持 Vue 组件的写法，还内置 <code>Stylus</code> 语法。</p><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="custom-container warning"><p class="custom-container-title">注意</p><p>本博客VuePress主版本为<code>0.x</code>，相关配置最新的<code>1.x</code>也兼容，请放心使用。另请确认你的Node.js &gt;= 8</p></div><h3 id="全局安装-推荐" tabindex="-1"><a class="header-anchor" href="#全局安装-推荐" aria-hidden="true">#</a> 全局安装(推荐)</h3><p>通常而言，全局安装 VuePress 会非常省心，可以通过如下命令进行全局安装</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> vuepress
...
<span class="token operator">|</span>   <span class="token operator">|</span><span class="token operator">--</span> icon<span class="token punctuation">.</span>png
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>基本导航栏配置结果</p><p><img src="`+m+`" alt="基本导航栏配置结果"></p><h4 id="导航栏下拉列表" tabindex="-1"><a class="header-anchor" href="#导航栏下拉列表" aria-hidden="true">#</a> 导航栏下拉列表</h4><p>下拉列表需要配置<code>items</code>属性，它是一个数组，数组里的对象依然是一个普通导航对象，即拥有<code>text</code>和<code>link</code>属性，一个导航栏下拉列表可以配置成如下所示</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token comment">// 其它配置</span>
  <span class="token literal-property property">themeConfig</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">nav</span><span class="token operator">:</span> <span class="token punctuation">[</span>
      <span class="token punctuation">{</span> <span class="token literal-property property">text</span><span class="token operator">:</span> <span class="token string">&#39;首页&#39;</span><span class="token punctuation">,</span> <span class="token literal-property property">link</span><span class="token operator">:</span> <span class="token string">&#39;/&#39;</span> <span class="token punctuation">}</span><span class="token punctuation">,</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>导航栏下拉列表配置结果</p><p><img src="`+y+'" alt="导航栏下拉列表配置结果"></p><h4 id="下拉列表分组" tabindex="-1"><a class="header-anchor" href="#下拉列表分组" aria-hidden="true">#</a> 下拉列表分组</h4><div class="custom-container tip"><p class="custom-container-title">说明</p><p>下拉列表分组适用于下拉选项较多的情况</p></div><p>相信熟悉<code>Vue.js</code>官网的你，一定看过如下的下拉框情况</p><p><img src="'+v+`" alt="下拉列表分组"> 要实现以上的情况，可以如下进行配置</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">themeConfig</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">nav</span><span class="token operator">:</span> <span class="token punctuation">[</span>
      <span class="token punctuation">{</span> <span class="token literal-property property">text</span><span class="token operator">:</span> <span class="token string">&#39;首页&#39;</span><span class="token punctuation">,</span> <span class="token literal-property property">link</span><span class="token operator">:</span> <span class="token string">&#39;/&#39;</span> <span class="token punctuation">}</span><span class="token punctuation">,</span>
      <span class="token punctuation">{</span> <span class="token literal-property property">text</span><span class="token operator">:</span> <span class="token string">&#39;前端三剑客&#39;</span><span class="token punctuation">,</span> <span class="token literal-property property">items</span><span class="token operator">:</span> <span class="token punctuation">[</span>
...
<span class="token operator">|</span>   <span class="token operator">|</span><span class="token operator">--</span> <span class="token constant">README</span><span class="token punctuation">.</span>md
</code></pre></div><p>侧边栏分组的结果</p><p><img src="`+x+`" alt="侧边栏分组结果"></p><h4 id="自动生成侧边栏" tabindex="-1"><a class="header-anchor" href="#自动生成侧边栏" aria-hidden="true">#</a> 自动生成侧边栏</h4><div class="custom-container tip"><p class="custom-container-title">说明</p><p>如果我们仅仅只是希望能根据<code>.md</code>中的标题自动生成侧边栏的话，可以设置<code>sidebar: auto</code>属性即可</p></div><p>如果我们要为所有<code>.md</code>都开启自动生成侧边栏的话，需要进行如下配置</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">themeConfig</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>配置了编辑链接后结果可能如下图所示</p><p><img src="`+f+`" alt="编辑功能"></p><p>你也可以通过设置<code>YAML</code>来单独禁止某个<code>.md</code>文件启用编辑链接功能</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">---</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>配置后，代码块行号的结果如下图所示</p><p><img src="`+j+'" alt="代码块行号"></p><h3 id="使用emoji表情" tabindex="-1"><a class="header-anchor" href="#使用emoji表情" aria-hidden="true">#</a> 使用Emoji表情</h3><div class="custom-container warning"><p class="custom-container-title">注意</p><p>并不是所有<code>Emoji</code>表情都支持</p></div>',144)),a("p",null,[s[10]||(s[10]=n("在")),s[11]||(s[11]=a("code",null,".md",-1)),s[12]||(s[12]=n("文件中，我们可以使用")),s[13]||(s[13]=a("code",null,"Emoji",-1)),s[14]||(s[14]=n("表情，你也可以访问")),a("a",D,[s[8]||(s[8]=n("Emoji Search")),t(e)]),s[15]||(s[15]=n("来查询你喜欢的")),s[16]||(s[16]=a("code",null,"Emoji",-1)),s[17]||(s[17]=n("表情，访问")),a("a",I,[s[9]||(s[9]=n("Common Emoji")),t(e)]),s[18]||(s[18]=n("来访问常用的")),s[19]||(s[19]=a("code",null,"Emoji",-1)),s[20]||(s[20]=n("，一个")),s[21]||(s[21]=a("code",null,"Emoji",-1)),s[22]||(s[22]=n("可以是这样写的"))]),s[40]||(s[40]=p(`<div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">####</span> 这里是Emoji表情 :tada:</span>
:100: :rocket:
...
<span class="token title important"><span class="token punctuation">###</span> h3标题</span>
<span class="token title important"><span class="token punctuation">###</span> h3标题</span>
</code></pre></div><p>它的结果可能如下所示</p><p><img src="`+w+`" alt="目录"></p><h3 id="使用vue模板语法" tabindex="-1"><a class="header-anchor" href="#使用vue模板语法" aria-hidden="true">#</a> 使用Vue模板语法</h3><h4 id="使用插值" tabindex="-1"><a class="header-anchor" href="#使用插值" aria-hidden="true">#</a> 使用插值</h4><p>在<code>.md</code>文件中，可以使用 Vue 的插值表达式，像下面这样</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">#</span> 插值表达式</span>
1 + 1 的结果是 {{1+1}}
...
</code></pre></div>`,4)),a("h4",N,[s[27]||(s[27]=a("a",{class:"header-anchor",href:"#vue","aria-hidden":"true"},"#",-1)),s[28]||(s[28]=n(" Vue ")),t(o,{text:"2.5.0+"})]),a("h4",G,[s[29]||(s[29]=a("a",{class:"header-anchor",href:"#vuex","aria-hidden":"true"},"#",-1)),s[30]||(s[30]=n(" Vuex ")),t(o,{text:"beta",type:"warn",vertical:"top"})]),a("h4",W,[s[31]||(s[31]=a("a",{class:"header-anchor",href:"#vue-resource","aria-hidden":"true"},"#",-1)),s[32]||(s[32]=n(" Vue-Resource")),t(o,{text:"废弃",vertical:"middle",type:"error"})]),s[43]||(s[43]=p(`<h3 id="使用vue组件" tabindex="-1"><a class="header-anchor" href="#使用vue组件" aria-hidden="true">#</a> 使用Vue组件</h3><p>VuePress 除了让我们使用内置组件以外，还可以让我们使用自己的组件，它默认把在<code>.vuepress/components</code>目录下所有的组件全局注册，注册后我们可以直接在<code>.md</code>文件中使用。 我们先在<code>.vuepress/components</code>目录下(无则新建)一个<code>customer-component</code>的<code>.vue</code>文件，它的内容如下所示</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token operator">&lt;</span>template<span class="token operator">&gt;</span>
...
</code></pre></div><p>VuePress 运行结果</p><p><img src="`+q+`" alt="VuePress运行结果"></p><h2 id="进阶配置" tabindex="-1"><a class="header-anchor" href="#进阶配置" aria-hidden="true">#</a> 进阶配置</h2><h3 id="基本配置api" tabindex="-1"><a class="header-anchor" href="#基本配置api" aria-hidden="true">#</a> 基本配置API</h3><h4 id="title-标题" tabindex="-1"><a class="header-anchor" href="#title-标题" aria-hidden="true">#</a> title(标题)</h4><div class="custom-container tip"><p class="custom-container-title">说明</p><p><code>title</code>标题能让我们配置静态站点的标题，它固定在我们顶部左上角</p></div><p>可以像下面这样来配置<code>title</code></p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token comment">// 其它配置</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>配置后的结果如下图所示</p><p><img src="`+C+`" alt="title配置结果"></p><h4 id="description-网站的描述" tabindex="-1"><a class="header-anchor" href="#description-网站的描述" aria-hidden="true">#</a> description(网站的描述)</h4><div class="custom-container tip"><p class="custom-container-title">说明</p><p><code>description</code>它将会以 <code>&lt;meta&gt;</code> 标签渲染到当前页面的 HTML 中，它是给搜索引擎去识别的，这属于<code>SEO</code>配置</p></div><p>可以像下面这样配置<code>description</code></p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token comment">// 其它配置</span>
...
&lt;&lt;&lt; @filepath{highlightLines}
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><div class="custom-container warning"><p class="custom-container-title">注意</p><p>不同于内置搜索的开箱即用，使用<code>Algolia</code>搜索，需要我们将网站提交给它们以建立索引</p></div>`,60)),a("p",null,[s[34]||(s[34]=n("此小结的配置由于特殊性，并没有配置成功，如果你感兴趣，请移步这里👉")),a("a",Y,[s[33]||(s[33]=n("Algolia搜索")),t(e)]),s[35]||(s[35]=a("br",null,null,-1)),s[36]||(s[36]=n(" 如果你配置成功了，它们的搜索效果会是下面这样子的(")),s[37]||(s[37]=a("strong",null,"Vue官网",-1)),s[38]||(s[38]=n(")"))]),s[44]||(s[44]=p('<p><img src="'+M+`" alt="Algolia搜索"></p><h3 id="管理静态资源" tabindex="-1"><a class="header-anchor" href="#管理静态资源" aria-hidden="true">#</a> 管理静态资源</h3><p>在<code>.md</code>文件中，如果我们要使用静态资源，我们有如下几种方式来引用资源</p><ul><li>相对路径/绝对路径</li><li><code>Webpack</code> 别名<br></li></ul><p>下面我们来一一进行介绍</p><h4 id="相对路径" tabindex="-1"><a class="header-anchor" href="#相对路径" aria-hidden="true">#</a> 相对路径</h4><p>要在<code>.md</code>文件中引用一个图片资源，它的固定格式如下</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code>// 格式
...
<span class="token punctuation">---</span>
</code></pre></div><p>使用自定义样式它的结果</p><p><img src="`+A+`" alt="自定义样式的结果"></p><h3 id="自定义页面布局" tabindex="-1"><a class="header-anchor" href="#自定义页面布局" aria-hidden="true">#</a> 自定义页面布局</h3><p>在默认主题下，每一个<code>.md</code>文件都会被渲染在<code>&lt;div class=&quot;page&quot;&gt;&lt;/div&gt;</code>这样的一个标签中，同时生成页面的侧边栏、编辑链接(如果有)、最新更新时间(如果有)以及上一篇/下一篇(如果有)。<br> 但是如果我们不想生成这样的页面，而是想使用自定义布局，也就是使用<code>Vue</code>组件来进行自定义页面开发，VuePress提供给了我们这样的能力，它在<strong>保留导航栏</strong>的基础上，其它一切我们都可以自定义的，它的配置可能是这样的</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code>// 在需要自定义的.md文件中使用YAML语法
<span class="token punctuation">---</span>
...
</code></pre></div><p>使用自定义布局的结果如下</p><p><img src="`+T+`" alt="自定义布局"></p><h3 id="使用第三方主题" tabindex="-1"><a class="header-anchor" href="#使用第三方主题" aria-hidden="true">#</a> 使用第三方主题</h3><p>VuePress支持使用第三方主题，需要在<code>.vuepress/config.js</code>中如下进行配置即可</p><div class="custom-container tip"><p class="custom-container-title">提醒</p><p>VuePress的插件，命名是固定的，一般为<code>vuepress-theme-xxx</code>，<code>npm install</code>安装第三方主题后，在配置时只需要写最后一个名字即可。例如：<code>vuepress-theme-reco</code>主题，只需如下进行配置即可。</p></div><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token comment">// 其它配置</span>
...
</code></pre></div><h4 id="新建仓库并创建github-pages分支" tabindex="-1"><a class="header-anchor" href="#新建仓库并创建github-pages分支" aria-hidden="true">#</a> 新建仓库并创建Github Pages分支</h4><p>新建一个<code>github</code>仓库和新建分支的具体步骤就不在此累述，如果你新建成功了的话，你的仓库看起来应该是这样子的</p><p><img src="`+B+`" alt="新建仓库和分支"></p><h4 id="提交到github" tabindex="-1"><a class="header-anchor" href="#提交到github" aria-hidden="true">#</a> 提交到Github</h4><p>上面我们新建了一个远程仓库，我们可以在<code>dist</code>目录下进行如下的命令</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>// 新建仓库
...
</code></pre></div><p>在提交成功后，可以通过<code>https://xxx.github.io</code>或者<code>https://xxx.github.io/xxx/</code>进行访问</p><div class="custom-container warning"><p class="custom-container-title">提醒</p><p>关于自动化部署，如果你是新手，那么按照正常的流程提交代码到远程仓库即可，不建议新手使用自动化部署。</p></div>`,58))])}const z=u($,[["render",O],["__file","index.html.vue"]]);export{z as default};
