...
<span class="line"></span></code></pre></div><p>至此，网页数据已经向量化存入到我们的内存中。</p><p>接下来，需要安装<code>langgraph</code>：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">$ pip <span class="token function">install</span> langgraph</span>
<span class="line"></span></code></pre></div><p>然后设置定义<code>State</code>、<code>Retriever</code>和<code>Generation</code>。</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token keyword">from</span> langchain <span class="token keyword">import</span> hub</span>
...
<span class="line"></span></code></pre></div><p>最后定义<code>Graph</code>并调用大模型<code>API</code>得到结果：</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line">graph <span class="token operator">=</span> <span class="token punctuation">(</span></span>
...
<span class="line"></span></code></pre></div><p>最后回答：</p><div class="language-text" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">《黑神话：悟空》是由游戏科学开发的动作角色扮演游戏，于2024年8月20日发布。</span>
<span class="line"></span></code></pre></div>`,18)]))}const i=s(e,[["render",o]]),u=JSON.parse('{"path":"/rag/basic/langgraph/","title":"LangGraph实现RAG","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1753279414000,"contributors":[{"name":"wangtunan","username":"wangtunan","email":"why583440138@gmail.com","commits":1,"url":"https://github.com/wangtunan"}],"changelog":[{"hash":"f6a7e215adf95094eacc8aae06d3956f57de5da6","time":1753279414000,"email":"why583440138@gmail.com","author":"wangtunan","message":"blog RAG结构化文档索引前处理文章撰写"}]},"filePathRelative":"rag/basic/langgraph/README.md"}');export{i as comp,u as data};
