import{_ as e,r as c,o as u,c as l,a as t,b as o,e as a,d as p}from"./app-f337e525.js";const k={};function r(i,n){const s=c("leetcode-link");return u(),l("div",null,[n[0]||(n[0]=t("h1",{id:"中等",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#中等","aria-hidden":"true"},"#"),o(" 中等")],-1)),n[1]||(n[1]=t("h2",{id:"_98-验证二叉搜索树",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#_98-验证二叉搜索树","aria-hidden":"true"},"#"),o(" 98.验证二叉搜索树")],-1)),a(s,{title:"98.验证二叉搜索树",link:"https://leetcode.cn/problems/validate-binary-search-tree"}),n[2]||(n[2]=p(`<p>方法一：递归</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// n为二叉树的节点数量</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="_102-二叉树的层序遍历" tabindex="-1"><a class="header-anchor" href="#_102-二叉树的层序遍历" aria-hidden="true">#</a> 102.二叉树的层序遍历</h2>`,5)),a(s,{title:"102.二叉树的层序遍历",link:"https://leetcode.cn/problems/binary-tree-level-order-traversal"}),n[3]||(n[3]=p(`<div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// n为二叉树节点的数量</span>
<span class="token comment">// 时间复杂度：O(n)，需要遍历每一个节点</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div><h2 id="_105-从前序与中序遍历序列构造二叉树" tabindex="-1"><a class="header-anchor" href="#_105-从前序与中序遍历序列构造二叉树" aria-hidden="true">#</a> 105.从前序与中序遍历序列构造二叉树</h2>`,2)),a(s,{title:"105.从前序与中序遍历序列构造二叉树",link:"https://leetcode.cn/problems/construct-binary-tree-from-preorder-and-inorder-traversal"}),n[4]||(n[4]=p(`<p>方法一：递归 + 哈希表</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// n为二叉树节点的数量</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="_114-二叉树展开为链表" tabindex="-1"><a class="header-anchor" href="#_114-二叉树展开为链表" aria-hidden="true">#</a> 114.二叉树展开为链表</h2>`,5)),a(s,{title:"114.二叉树展开为链表",link:"https://leetcode.cn/problems/flatten-binary-tree-to-linked-list"}),n[5]||(n[5]=p(`<p>方法一：前序遍历 + 存储节点</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// way1: 前序遍历 + 存储节点</span>
...
<span class="token keyword">var</span> <span class="token function-variable function">flatten</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">root</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="_199-二叉树的右视图" tabindex="-1"><a class="header-anchor" href="#_199-二叉树的右视图" aria-hidden="true">#</a> 199.二叉树的右视图</h2>`,5)),a(s,{title:"199.二叉树的右视图",link:"https://leetcode.cn/problems/binary-tree-right-side-view"}),n[6]||(n[6]=p(`<p>方法一：广度优先遍历(BFS)</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// way1: 广度优先遍历(BFS) + 存储每层最后一个元素</span>
<span class="token comment">// n为二叉树节点的数量</span>
<span class="token comment">// 时间复杂度：O(n)，需要遍历每一个节点</span>
...
<span class="token keyword">var</span> <span class="token function-variable function">rightSideView</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">root</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> result<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="_230-二叉搜索树中第k小的元素" tabindex="-1"><a class="header-anchor" href="#_230-二叉搜索树中第k小的元素" aria-hidden="true">#</a> 230.二叉搜索树中第K小的元素</h2>`,5)),a(s,{title:"230.二叉搜索树中第K小的元素",link:"https://leetcode.cn/problems/kth-smallest-element-in-a-bst"}),n[7]||(n[7]=p(`<p>方法一：中序遍历(二叉搜索树中序遍历为升序数组)</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// way1: 中序遍历(二叉搜索树中序遍历为升序数组)</span>
<span class="token comment">// 时间复杂度：O(n)，需要遍历每一个节点</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div><h2 id="_236-二叉树的最近公共祖先" tabindex="-1"><a class="header-anchor" href="#_236-二叉树的最近公共祖先" aria-hidden="true">#</a> 236.二叉树的最近公共祖先</h2>`,3)),a(s,{title:"236.二叉树的最近公共祖先",link:"https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree"}),n[8]||(n[8]=p(`<p>方法一：深度优先遍历</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// way1: 深度优先遍历</span>
...
<span class="token keyword">var</span> <span class="token function-variable function">lowestCommonAncestor</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">root<span class="token punctuation">,</span> p<span class="token punctuation">,</span> q</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> root<span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div><h2 id="_437-路径总和-iii" tabindex="-1"><a class="header-anchor" href="#_437-路径总和-iii" aria-hidden="true">#</a> 437.路径总和 III</h2>`,3)),a(s,{title:"236.二叉树的最近公共祖先",link:"https://leetcode.cn/problems/path-sum-iii"}),n[9]||(n[9]=p(`<p>方法一：深度优先遍历(以每个节点为root，探索所有的路径和)</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// way1: 深度优先遍历(以每个节点为root，探索所有的路径和)</span>
<span class="token comment">// n为二叉树节点的数量</span>
...
<span class="token keyword">var</span> <span class="token function-variable function">pathSum</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">root<span class="token punctuation">,</span> targetSum</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> total<span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div>`,2))])}const m=e(k,[["render",r],["__file","index.html.vue"]]);export{m as default};
