import{_ as n,o as e,c as s,d as t}from"./app-b584e672.js";const o="/blog/assets/1-af3b7f18.png",c="/blog/assets/2-c0faa40d.png",d="/blog/assets/3-c38dac8e.png",i="/blog/assets/4-7895177d.png",p="/blog/assets/5-c5db20e9.png",r={};function l(h,a){return e(),s("div",null,a[0]||(a[0]=[t('<h1 id="精通git" tabindex="-1"><a class="header-anchor" href="#精通git" aria-hidden="true">#</a> 精通Git</h1><h2 id="起步" tabindex="-1"><a class="header-anchor" href="#起步" aria-hidden="true">#</a> 起步</h2><h3 id="版本控制" tabindex="-1"><a class="header-anchor" href="#版本控制" aria-hidden="true">#</a> 版本控制</h3><p>版本控制<code>VCS</code>是一套系统，该系统按时间顺序记录某一个或一系列文件的变更，让我们可以查看其以前的特定版本，其有三种类别：<strong>本地版本控制系统</strong>、<strong>集中式版本控制系统</strong>、<strong>分布式版本控制系统</strong>。</p><h4 id="本地版本控制系统" tabindex="-1"><a class="header-anchor" href="#本地版本控制系统" aria-hidden="true">#</a> 本地版本控制系统</h4><p>很多人控制版本的方式是将文件复制到另一个文件目录，甚至还会给目录加上一个时间戳，这种做法很常见，而且很容易实现。但这种方式也同样出错，随后衍生出来的<code>RCS</code>工具，它是一种常见的<code>VCS</code>工具，它会在磁盘上以一种特殊的格式保存补丁集。</p><p><img src="'+o+'" alt="本地版本控制系统"></p><h4 id="集中式版本控制系统" tabindex="-1"><a class="header-anchor" href="#集中式版本控制系统" aria-hidden="true">#</a> 集中式版本控制系统</h4><p>由于本地版本控制系统无法解决多人协作问题，集中式版本控制系统<code>CVCS</code>也就应运而生了。它与本地版本控制系统相比，有多方面的优势：</p><ul><li>所有人在一定程度上知道其他人在项目里做了什么。</li><li>管理员可以精细的控制每一个人的权限。</li><li>维护一个集中式版本控制系统要比在每台客户机上都维护一个数据库简单得多。</li></ul><p>但集中式版本控制系统也不是没有缺点的，它最大的缺点是故障问题：如果集中式服务器存在故障宕机，那么这期间任何人都不能协作或者提交更改；如果中央数据库所在的硬盘受损，备份也没有保住的情况下，代码将会面临全面丢失的风险。</p><p><img src="'+c+'" alt="集中式版本控制系统"></p><h4 id="分布式版本控制系统" tabindex="-1"><a class="header-anchor" href="#分布式版本控制系统" aria-hidden="true">#</a> 分布式版本控制系统</h4><p>为了针对解决以上集中式版本控制系统所存在的潜在问题，进而出现了分布式版本控制系统<code>DVCS</code>。对于一个分布式版本控制系统来说，客户端冰粉仅仅是检出文件的最新快照，而是对代码仓库进行完整的镜像。这样一来，无论哪一个服务器出现故障，任何一个客户端都可以使用自己本地的镜像来恢复服务器。</p><p><img src="'+d+'" alt="分布式版本控制系统"></p><p>除了以上提到的有点，分布式版本控制系统可以很好的处理多个远程仓库。</p><h3 id="简史" tabindex="-1"><a class="header-anchor" href="#简史" aria-hidden="true">#</a> 简史</h3><p>同许多伟大的事物一样，<code>Git</code>的诞生伴随着许多颠覆式的创新以及激烈的争论。</p><ul><li>2002年，<code>Linux</code>内核项目开始采用一款叫做<code>BitKeeper</code>的专用分布式版本控制系统。</li><li>2005年，<code>Linux</code>开发者社区与<code>BitKeeper</code>研发公司关系破裂，该公司回收了软件的免费使用权，这个事情促使了<code>Linux</code>开发社区决定开发自己的版本控制系统。</li><li>2005年，<code>Git</code>版本控制系统诞生。</li></ul><p><code>Git</code>开发之初，它的设计目标如下：</p><ul><li>速度快</li><li>设计简洁</li><li>对于非线性开发强有力的支持</li><li>完全的分布式设计</li><li>能够有效的处理大象项目</li></ul><h3 id="git基础" tabindex="-1"><a class="header-anchor" href="#git基础" aria-hidden="true">#</a> Git基础</h3><h4 id="快照-而非差异" tabindex="-1"><a class="header-anchor" href="#快照-而非差异" aria-hidden="true">#</a> 快照，而非差异</h4><p><code>Git</code>与其他版本控制系统相比，最大的不同在于其对待数据的方式。</p><ul><li>其他版本控制系统：将其存储的信息视为一组文件以及对这些文件随时间所作出的变更。</li></ul><p><img src="'+i+'" alt="其他版本控制系统"></p><ul><li><code>Git</code>版本控制系统：每次提交或在<code>Git</code>中保存项目的状态时，<code>Git</code>会抓取一张所有文件当前状态的快照，然后存储一个指向该快照的引用。 <img src="'+p+`" alt="Git控制系统"></li></ul><h4 id="git的完整性" tabindex="-1"><a class="header-anchor" href="#git的完整性" aria-hidden="true">#</a> Git的完整性</h4><p><code>Git</code>的所有数据在存储前都会执行校验和计算，随后以校验和来引用对应的数据，其采用的校验和机制叫做<code>SHA-1</code>散列，它是一个由<code>40</code>个十六进制字符所组成的字符串，它是根据文件内容或<code>Git</code>的目录结构计算所得到的。一个<code>SHA-1</code>散列的案例如下：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>24b9da6552252987aa493b52f8696cd6d3b00373
