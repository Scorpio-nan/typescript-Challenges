...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>在这一小节，我们分析了<code>render</code>的实现，在下一小节我们将深入学习<code>createElement</code>方法的实现原理。</p>`,35)]))}const r=s(e,[["render",o],["__file","render.html.vue"]]);export{r as default};
