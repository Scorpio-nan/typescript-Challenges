import{_ as s,o as a,c as t,d as p}from"./app-f337e525.js";const o="/blog/assets/instance-b475d413.png",e="/blog/assets/initMixin-899510af.png",c={};function i(l,n){return a(),t("div",null,n[0]||(n[0]=[p(`<h1 id="initmixin流程" tabindex="-1"><a class="header-anchor" href="#initmixin流程" aria-hidden="true">#</a> initMixin流程</h1><p>在上一节我们讲到了<code>initGlobalAPI</code>的整体流程，这一节，我们来介绍<code>initMixin</code>的整体流程。首先，我们把目光回到<code>src/core/index.js</code>文件中：</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> Vue <span class="token keyword">from</span> <span class="token string">&#39;./instance/index&#39;</span>
...
<span class="token punctuation">}</span>
    ...
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
</code></pre></div><p>因为我们是要分析<code>initMixin</code>整体流程，对于其中某些方法的具体实现逻辑会在后续进行详细的说明，因此我们可以从以上代码得到<code>initMixin</code>的整体流程图。</p><div style="text-align:center;"><img src="`+e+'"></div>',22)]))}const k=s(c,[["render",i],["__file","init.html.vue"]]);export{k as default};
