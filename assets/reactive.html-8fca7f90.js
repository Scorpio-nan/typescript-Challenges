import{_ as o,r as e,o as c,c as u,a,b as s,e as t,d as l}from"./app-f337e525.js";const k={},r={href:"https://www.caniuse.com/?search=Object.defineProperty",target:"_blank",rel:"noopener noreferrer"},i={href:"https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Object/defineProperty",target:"_blank",rel:"noopener noreferrer"};function d(y,n){const p=e("ExternalLinkIcon");return c(),u("div",null,[n[24]||(n[24]=a("h1",{id:"深入响应式原理",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#深入响应式原理","aria-hidden":"true"},"#"),s(" 深入响应式原理")],-1)),n[25]||(n[25]=a("p",null,[s("在介绍完"),a("code",null,"props"),s("、"),a("code",null,"data"),s("、"),a("code",null,"watch"),s("以及"),a("code",null,"computed"),s("后，我们对响应式原理有了一定的初步认识，在这一章节中我们再次回顾响应式，来探究其实现原理。")],-1)),a("p",null,[n[1]||(n[1]=s("在之前的章节中，我们已经介绍过：")),n[2]||(n[2]=a("code",null,"Vue.js",-1)),n[3]||(n[3]=s("通过")),n[4]||(n[4]=a("code",null,"Object.defineProperty(obj, key, descriptor)",-1)),n[5]||(n[5]=s("方法来定义响应式对象，我们可以在")),a("a",r,[n[0]||(n[0]=s("Can I Use")),t(p)]),n[6]||(n[6]=s("网站上搜索到，")),n[7]||(n[7]=a("code",null,"IE8",-1)),n[8]||(n[8]=s("浏览器并不支持这个方法，这就是")),n[9]||(n[9]=a("code",null,"Vue.js",-1)),n[10]||(n[10]=s("不支持")),n[11]||(n[11]=a("code",null,"IE8",-1)),n[12]||(n[12]=s("及其以下版本浏览器的真正原因。"))]),a("p",null,[n[14]||(n[14]=s("在")),a("a",i,[n[13]||(n[13]=s("MDN")),t(p)]),n[15]||(n[15]=s("网站上，我们可以发现这个方法支持很多个参数，其中")),n[16]||(n[16]=a("code",null,"descriptor",-1)),n[17]||(n[17]=s("支持许多个可选的属性，对于")),n[18]||(n[18]=a("code",null,"Vue.js",-1)),n[19]||(n[19]=s("实现响应式对象来说，最重要的是")),n[20]||(n[20]=a("code",null,"get",-1)),n[21]||(n[21]=s("和")),n[22]||(n[22]=a("code",null,"set",-1)),n[23]||(n[23]=s("属性。"))]),n[26]||(n[26]=l(`<div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">let</span> val <span class="token operator">=</span> <span class="token string">&#39;msg&#39;</span>
...
<span class="token keyword">this</span><span class="token punctuation">.</span>_props<span class="token punctuation">.</span>msg <span class="token operator">=</span> <span class="token string">&#39;new msg&#39;</span>
...
arr<span class="token punctuation">.</span><span class="token function">sort</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
arr<span class="token punctuation">.</span><span class="token function">reverse</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre></div><p>代码分析：我们可以从代码中看到，当浏览器不支持<code>__proto__</code>的时候，会把我们创建的<code>arrayMethods</code>变量上所有的<code>key</code>，遍历赋值到<code>value</code>数组上。</p>`,56))])}const m=o(k,[["render",d],["__file","reactive.html.vue"]]);export{m as default};
