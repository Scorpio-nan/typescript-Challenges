import{_ as e,r as c,o as l,c as u,d as o,a as s,b as a,e as t}from"./app-f337e525.js";const i={},k={href:"https://sass-lang.com/documentation/",target:"_blank",rel:"noopener noreferrer"},r={href:"https://www.sassmeister.com/",target:"_blank",rel:"noopener noreferrer"},d={href:"https://www.sassmeister.com/",target:"_blank",rel:"noopener noreferrer"},m={href:"https://sass-lang.com/documentation/at-rules/extend",target:"_blank",rel:"noopener noreferrer"},g={href:"https://sass-lang.com/documentation/modules/math",target:"_blank",rel:"noopener noreferrer"},b={href:"https://sass-lang.com/documentation/modules/list",target:"_blank",rel:"noopener noreferrer"},y={href:"https://sass-lang.com/documentation/modules/map",target:"_blank",rel:"noopener noreferrer"},v={href:"https://sass-lang.com/documentation/modules/meta",target:"_blank",rel:"noopener noreferrer"},x={href:"https://sass-lang.com/documentation/modules/selector",target:"_blank",rel:"noopener noreferrer"},h={href:"https://sass-lang.com/documentation/modules/string",target:"_blank",rel:"noopener noreferrer"},f={href:"https://sass-lang.com/documentation/modules/color",target:"_blank",rel:"noopener noreferrer"};function $(w,n){const p=c("ExternalLinkIcon");return l(),u("div",null,[n[23]||(n[23]=o('<h1 id="sass" tabindex="-1"><a class="header-anchor" href="#sass" aria-hidden="true">#</a> SASS</h1><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><p><code>SASS</code> 是一款强化<code>CSS</code>的辅助工具，它在<code>CSS</code>语法的基础上增加了变量 (<code>variables</code>)、嵌套 (<code>nested rules</code>)、混合 (<code>mixins</code>)、导入 (<code>inline imports</code>) 等高级功能，这些拓展令<code>CSS</code>更加强大与优雅。</p><p>参考文档和链接地址：</p>',4)),s("ul",null,[s("li",null,[s("a",k,[n[0]||(n[0]=a("SASS官网")),t(p)])]),s("li",null,[s("a",r,[n[1]||(n[1]=a("SASS Playground")),t(p)])])]),n[24]||(n[24]=s("h2",{id:"安装",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#安装","aria-hidden":"true"},"#"),a(" 安装")],-1)),n[25]||(n[25]=s("p",null,[a("你可以使用如下两种方式来学习体验"),s("code",null,"SASS"),a("：")],-1)),s("ul",null,[s("li",null,[n[3]||(n[3]=a("在线方式：")),s("a",d,[n[2]||(n[2]=a("SASS Playground")),t(p)]),n[4]||(n[4]=a(" 提供即时编译结果，适合快速学习。"))]),n[5]||(n[5]=s("li",null,[a("通过"),s("code",null,"sass"),a("的"),s("code",null,"npm"),a("包自主编译，适合深入学习(本篇文章采用方式，推荐)。")],-1))]),n[26]||(n[26]=o(`<p>首先，你需要按照下面命令创建一个新的项目，然后使用<code>npm</code>命令初始化生成<code>package.json</code>文件，如下：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建目录</span>
...
</code></pre></div>`,36)),s("p",null,[n[10]||(n[10]=a("其它变量和函数，请点击")),s("a",g,[n[9]||(n[9]=a("Math内置变量和函数")),t(p)])]),n[28]||(n[28]=o(`<h3 id="list" tabindex="-1"><a class="header-anchor" href="#list" aria-hidden="true">#</a> list</h3><p>常用的<code>list</code>内置函数有：</p><ul><li><code>append($list, $val, $separator: auto) =&gt; list</code>：向<code>list</code>列表中添加一个新元素，其中<code>$separator</code>为可选参数，有三种取值(<code>space</code>空格， <code>comma</code>逗号，<code>slash</code>斜杠)，全局函数用。</li><li><code>index($list, $val) =&gt; index | null</code>: 返回<code>list</code>列表中，<code>$val</code>元素的索引位置(从1开始，而不是0)，没有则返回<code>null</code>，全局函数。</li><li><code>join($list1, $list2, $separator: auto, $bracketed: auto) =&gt; list</code>: 把<code>list1</code>列表和<code>list2</code>列表联合起来，返回一个新的列表，全局函数。</li><li><code>length($list) =&gt; number</code>: 返回<code>list</code>列表的长度，全局函数。</li><li><code>nth($list, $index)</code>: 在<code>list</code>列表中按索引取值<code>index</code>取值，全局函数。</li><li><code>set-nth($list, $index, $value)</code>: 在<code>list</code>列表中按索引设置值，全局函数。</li></ul><div class="language-scss" data-ext="scss"><pre class="language-scss"><code><span class="token property"><span class="token variable">$list1</span></span><span class="token punctuation">:</span> 10px<span class="token punctuation">,</span> 20px<span class="token punctuation">;</span>
...
<span class="token atrule"><span class="token rule">@media</span> only screen <span class="token operator">and</span> <span class="token punctuation">(</span><span class="token property">min-width</span><span class="token punctuation">:</span> 1200px<span class="token punctuation">)</span></span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,7))])}const q=e(i,[["render",$],["__file","index.html.vue"]]);export{q as default};
