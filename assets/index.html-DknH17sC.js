import{_ as a,c as s,b as p,o as e}from"./app-CGN7-aqw.js";const t={};function o(c,n){return e(),s("div",null,n[0]||(n[0]=[p(`<h1 id="前置准备" tabindex="-1"><a class="header-anchor" href="#前置准备"><span>前置准备</span></a></h1><div class="hint-container tip"><p class="hint-container-title">提示</p><p>所有跟llm请求相关的，默认都基于DeepSeek</p></div><p>首先定义环境变量文件<code>.env</code>，其代码如下：</p><div class="language-env" data-highlighter="prismjs" data-ext="env"><pre><code class="language-env"><span class="line"># DeepSeek api key</span>
...
<span class="line"></span></code></pre></div><p>然后安装一个依赖包：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">$ pip <span class="token function">install</span> dotenv</span>
<span class="line"></span></code></pre></div><p>接着定义两个文件<code>env_tools.py</code>和<code>chain.py</code>，其代码分别是：</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment"># env_tools.py</span></span>
...
<span class="line"></span></code></pre></div><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment"># chain.py</span></span>
...
<span class="line"></span></code></pre></div>`,9)]))}const i=a(t,[["render",o]]),u=JSON.parse('{"path":"/rag/basic/prepare/","title":"前置准备","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1753279414000,"contributors":[{"name":"wangtunan","username":"wangtunan","email":"why583440138@gmail.com","commits":1,"url":"https://github.com/wangtunan"}],"changelog":[{"hash":"f6a7e215adf95094eacc8aae06d3956f57de5da6","time":1753279414000,"email":"why583440138@gmail.com","author":"wangtunan","message":"blog RAG结构化文档索引前处理文章撰写"}]},"filePathRelative":"rag/basic/prepare/README.md"}');export{i as comp,u as data};
