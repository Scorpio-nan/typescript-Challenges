...
</code></pre></div><ul><li><strong>observe(data)</strong>：<code>observe</code>的作用是把传入值所有的属性(包括嵌套属性)递归的进行响应式<code>defineReactive</code>，我们会在之后的章节中详细介绍<code>observe</code>的实现原理，在<code>initData</code>中我们只要知道<code>observe(data)</code>会把<code>data</code>函数返回对象的所有属性全部变成响应式的即可。</li></ul><p>在分析完<code>initData</code>的实现后，我们可以得到<code>initData</code>的整体流程图。</p><div style="text-align:center;"><img src="`+o+'"></div>',20)]))}const k=a(e,[["render",c],["__file","data.html.vue"]]);export{k as default};
