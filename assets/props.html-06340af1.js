import{_ as s,o as a,c as p,d as t}from"./app-f337e525.js";const o="/blog/assets/props-f4eacb89.png",e={};function c(l,n){return a(),p("div",null,n[0]||(n[0]=[t(`<h1 id="props处理" tabindex="-1"><a class="header-anchor" href="#props处理" aria-hidden="true">#</a> props处理</h1><p>介绍完以上前置核心概念后，我们第一个要学习的就是<code>Vue.js</code>是如何处理与<code>props</code>相关的逻辑的。</p><p>我们把与<code>props</code>相关的逻辑主要分成三个部分，分别是<code>props</code>规范化、<code>props</code>初始化和<code>props</code>更新。</p><h2 id="props规范化" tabindex="-1"><a class="header-anchor" href="#props规范化" aria-hidden="true">#</a> props规范化</h2><p>在了解规范化之前，我们先来列举一下在日常的开发过程中，主要有如下几种撰写组件<code>props</code>的方式：</p><ul><li>数组形式：<code>props</code>可以写成一个数组，但数组中的<code>key</code>元素必须为<code>string</code>类型。</li></ul><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span> 
</code></pre></div><p>可以发现，规范化<code>props</code>的代码，主要集中在<code>normalizeProps()</code>方法中，那么接下来我们详细分析<code>normalizeProps()</code>方法：</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">normalizeProps</span> <span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">options</span><span class="token operator">:</span> Object<span class="token punctuation">,</span> <span class="token literal-property property">vm</span><span class="token operator">:</span> <span class="token operator">?</span>Component</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="整体流程图" tabindex="-1"><a class="header-anchor" href="#整体流程图" aria-hidden="true">#</a> 整体流程图</h2><p>在分析完以上所有与<code>props</code>相关的逻辑后，我们可以总结如下流程图。</p><div style="text-align:center;"><img src="`+o+'"></div>',103)]))}const u=s(e,[["render",c],["__file","props.html.vue"]]);export{u as default};
